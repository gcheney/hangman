...
/**
 * The Hangman class manages the logic of the game
 * and gives the information back to the UI layer
 * @author glen
 *
 */
public class Hangman {
	...
	public int getNumGuesses(char c) {
		int correct = 0;
	...
	public String updateHangman(char c) {			
		...
		if (correctLetter == 0){
			...
			JOptionPane.showMessageDialog(null,
					"Good guess! That letter appears " 
							+ correctLetter + " times!",
